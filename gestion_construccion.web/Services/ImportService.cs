    ...
    public class ImportService : IImportService
    {
        ...
        public async Task<ImportResultViewModel> ImportarDatosDesdeExcelAsync(Stream stream)
        {
            ...
            using (var package = new ExcelPackage(stream))
            {
                ...
                result.FilasProcesadas = rowCount - 1; // Se resta la cabecera
                    ...
                    try
                    {
                        ...
                        if (!clientesCache.TryGetValue(clienteEmail, out var cliente))
                        {
                            ...
                            if (cliente == null)
                            {
                                ...
                                await _unitOfWork.CompleteAsync(); // <-- Guardar inmediatamente
                        ...
                        if (!productosCache.TryGetValue(productoNombre, out var producto))
                        {
                            ...
                            if (producto == null)
                            {
                                ...
                                await _unitOfWork.CompleteAsync(); // Guardar inmediatamente para obtener ID
